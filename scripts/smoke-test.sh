...
echo -n "[Test 1/4] Edge Function Auth Rejection without CRON_SECRET... "
...
echo -n "[Test 2/4] Tenant Isolation / Ingest Foreign Pin Scoping... "
...
echo -n "[Test 3/4] Retention Cleanup Endpoint Execution... "
...
echo -n "[Test 4/4] Analytics cache_bypass Permission Check... "
