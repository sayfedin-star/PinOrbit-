...
REVOKE EXECUTE ON FUNCTION public.purge_old_pin_delivery_logs(INT, INT) FROM PUBLIC;
REVOKE EXECUTE ON FUNCTION public.purge_old_pin_delivery_logs(INT, INT) FROM anon;
REVOKE EXECUTE ON FUNCTION public.purge_old_pin_delivery_logs(INT, INT) FROM authenticated;
GRANT EXECUTE ON FUNCTION public.purge_old_pin_delivery_logs(INT, INT) TO service_role;
